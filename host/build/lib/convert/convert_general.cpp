...
/***********************************************************************
 * This file was generated by gen_convert_general.py on Wed Sep 13 10:15:28 2017
 **********************************************************************/
...
DECLARE_CONVERTER(s16_item32_be, 1, s16, 1, PRIORITY_GENERAL) {
    ...
    // 2) If nsamps was not a multiple of 2, copy the last one by hand
    if (nsamps % 2) {
        item32_t tmp = uhd::ntohx(input[n_words]);
...
DECLARE_CONVERTER(s16_item32_le, 1, s16, 1, PRIORITY_GENERAL) {
    ...
    // 2) If nsamps was not a multiple of 2, copy the last one by hand
    if (nsamps % 2) {
        item32_t tmp = uhd::wtohx(input[n_words]);
        *reinterpret_cast<s16_t *>(&output[n_words]) = s16_t(tmp);
    }
}
