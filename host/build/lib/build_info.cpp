...
namespace uhd { namespace build_info {
    ...
    const std::string build_date() {
        return "Mon, 16 Oct 2017 16:05:12";
    }
    ...
    const std::string c_flags() {
        return boost::algorithm::replace_all_copy(
            (define_flag + std::string("UHD_IMAGES_DIR=OFF;HAVE_CONFIG_H;UHD_LOG_MIN_LEVEL=1;UHD_LOG_CONSOLE_LEVEL=2;UHD_LOG_FILE_LEVEL=2;UHD_LOG_CONSOLE_COLOR")),
    ...
    const std::string cxx_flags() {
        return boost::algorithm::replace_all_copy(
            (define_flag + std::string("UHD_IMAGES_DIR=OFF;HAVE_CONFIG_H;UHD_LOG_MIN_LEVEL=1;UHD_LOG_CONSOLE_LEVEL=2;UHD_LOG_FILE_LEVEL=2;UHD_LOG_CONSOLE_COLOR -fvisibility=hidden -fvisibility-inlines-hidden")),
            std::string(";"), (" " + define_flag)
        );
    }
