...
static void set_llr_reg11(radio_ctrl_core_3000::sptr iface, const uint32_t val)
{
	iface->poke32(TOREG(SR_LLR_REG11), val);
}
static void set_llr_reg12(radio_ctrl_core_3000::sptr iface, const uint32_t val)
{
	iface->poke32(TOREG(SR_LLR_REG12), val);
}
static void set_llr_reg13(radio_ctrl_core_3000::sptr iface, const uint32_t val)
{
	iface->poke32(TOREG(SR_LLR_REG13), val);
}
static void set_llr_reg14(radio_ctrl_core_3000::sptr iface, const uint32_t val)
{
	iface->poke32(TOREG(SR_LLR_REG14), val);
}
static void set_llr_reg15(radio_ctrl_core_3000::sptr iface, const uint32_t val)
{
	iface->poke32(TOREG(SR_LLR_REG15), val);
}
static void set_llr_reg16(radio_ctrl_core_3000::sptr iface, const uint32_t val)
{
	iface->poke32(TOREG(SR_LLR_REG16), val);
}
static void set_llr_reg17(radio_ctrl_core_3000::sptr iface, const uint32_t val)
{
	iface->poke32(TOREG(SR_LLR_REG17), val);
}
static void set_llr_reg18(radio_ctrl_core_3000::sptr iface, const uint32_t val)
{
	iface->poke32(TOREG(SR_LLR_REG18), val);
}
static void set_llr_reg19(radio_ctrl_core_3000::sptr iface, const uint32_t val)
{
...
/*
	...
	while (!inFile.eof()) {
		...
		UHD_LOGGER_INFO("B200") << "Rohit file detected: " << file_spec << " " <<  ph;
		UHD_LOGGER_INFO("B200") << "Rohit file detected: " << file_spec << " " << comb_fq_am_ph;
