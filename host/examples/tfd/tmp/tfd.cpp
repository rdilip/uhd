...
static void _update(uhd::tx_streamer::sptr _tx_stream, std::vector<std::complex<float> > buff,
...
tfd::tfd(float _freq, float _gain, float _clock_rate, uint64_t _spb) {
	...
	std::string device_args("master_clock_rate=" + std::to_string(MASTER_CLOCK_RATE) + "e6,fpga=/home/thompsonlab/Desktop/build/usrp_b200_fpga.bin");
//Documents/fpga/usrp3/top/b200
